...
const gridSize = 20;
const proOptions = { hideAttriuion: true };
const nodeTypes = {
...
export const PipelineUI = () => {
  ...
  return (
    <Card ref={reactFlowWrapper} className="absolute inset-0 rounded-none bg-gradient-to-br from-violet-400 via-violet-800 to-zinc-950
